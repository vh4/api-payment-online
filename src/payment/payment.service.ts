...
export class PaymentService {
  ...
  /*
      service payment => hit to url partner to getting response and mapping response for payment.
      you can adding new product in case to getting response by partner.
      by tony.
  */

  async service(product: string, data: PaymentType): Promise<MandatoryType> {
